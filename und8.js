...
/*console.log(x++) /*Operador com encremento*/ /*operador de pos encremento (++) se colocar 
o ++ primeiro mostra o valor antigo e depois acrescenta 1
ex: 0 aumenta para 1
console.log(x)
console.log(x)*/

/*console.log(++x) operador de pre encremento // aumenta o valor da variavel e depois mostra
o valor ex: 1 aumenta para 2 */

/*console.log(x--) //pos decremento -- (mostra o valor da variavel e depois subtrai)// ex: 0-0 = 0
console.log(--x) // pos decremento -- remove 1 do valor da variavel e depois mostra ex: -1 -1 = 2 */

//-------------------------------------------------------------------------------------------//

//FUNÇÃO COM PARAMETROS INFINITOS//
...
// passar valor em colchete = passa um unico parametro //
// passar valor em aspas = recebendo mais de um parametro//
